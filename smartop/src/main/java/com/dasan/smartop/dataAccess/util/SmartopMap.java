package com.dasan.smartop.dataAccess.util;
...
public class SmartopMap extends ListOrderedMap {
	private static final Logger logger = LoggerFactory.getLogger(SmartopMap.class);
