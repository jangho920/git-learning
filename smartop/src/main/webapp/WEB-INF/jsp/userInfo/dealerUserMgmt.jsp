...
<script type="text/javascript">
    ...
    var fnOpenPopup = function(userId){
    	...
    	$("#layerPopup").load(  '<c:url value="/userInfo/dealerUserInfo.do" />'
    			              , param
    			              , function(){
    ...
    var fnDeleteUserList = function(){
    	...
    	if(chkCnt == 0 ){
    		alert("Please select your contents to delete");
    		return;
    	}
    ...
    $(document).on("click", "#btnAdd", function(e){
    	let param = {"menuParam" : '<c:out value="${data.menuParam}" />'};
    	$("#layerPopup").load(  '<c:url value="/userInfo/dealerUserReg.do" />'
    			              , param
    			              , function(){
    			            	  layerPopup("layerPopup");
    	                        });
