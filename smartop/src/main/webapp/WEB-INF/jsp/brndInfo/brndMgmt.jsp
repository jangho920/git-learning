...
<script type="text/javascript">
    	...
    	var param = {
              ...
              , "succCallback" : function(data){
             	 					...
             	 					for(var nIdx=0; nIdx<data.length; nIdx++){
                                        ...
                                        sTag += "<td onclick=\"fnOpenPopup('"+data[nIdx].dealerId+"', '"+data[nIdx].brandId+"')\">"+data[nIdx].brandNm+"</td>";
    ...
    var fnOpenPopup = function(dealerId, brandId){
    	...
    	$("#layerPopup").load(  '<c:url value="/brndInfo/brndInfo.do" />'
    			              , param
    			              , function(){
    ...
    $(document).on("click", "#btnAdd", function(e){
    	let param = {"menuParam" : '<c:out value="${data.menuParam}" />'};
    	$("#layerPopup").load(  '<c:url value="/brndInfo/brndReg.do" />'
    			              , param
    			              , function(){
    			            	  layerPopup("layerPopup");
    	                        });
            ...
            <div class="contents" >
                ...
                <div class="cardCont">
                    <div class="bbs-cond ccl4">
                        <h2 class="ti">Brand Management</h2>
                    </div>
